...
# 脚本配置
export SCRIPT_URL="https://raw.githubusercontent.com/yonggekkk/argosb/main/argosb1.sh"
export INSTALL_URL="https://raw.githubusercontent.com/JamesAlaHZS/remoteM/main/argosb1.sh"
